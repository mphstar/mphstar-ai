  ...
  return (
    <>
      ...
      <div className="flex flex-col h-[100dvh] flex-1 md:justify-center  w-screen container max-w-[1100px]">
        ...
        <div className="flex flex-col md:flex-row flex-1 md:flex-initial md:backdrop-blur-md h-[500px] mt-3 border-gray-100 ">
          <div className="hidden md:flex flex-col border-[1px] px-6 py-4 rounded-tl-[5px] rounded-bl-[5px]">
            <div className="flex flex-row items-center">
              <p className="font-semibold text-2xl flex-1">
                Chat <span className="text-gray-300 text-2xl">(1)</span>
              </p>
              <IoCreateSharp
                size={20}
              ...
              {image && (
                ...
                >
                  <div className="hover:bg-black/30 bg-black/0 absolute w-full h-full backdrop-blur-xs flex flex-col justify-center items-center duration-300 ease-in-out group">
                    <Trash
                      className="text-white group-hover:opacity-100 opacity-0 duration-300 ease-in-out"
                      color="white"
                    />
                  </div>
                  <img
